...
pub async fn create_monitor(
    ...
    if state
        ...
        .is_err()
    {
        warn!("No receivers for monitor change event (created: {name})");
    }
...
pub async fn update_monitor(
    ...
    if state
        ...
        .is_err()
    {
        warn!("No receivers for monitor change event (updated: {name})");
    }
...
pub async fn delete_monitor(
    ...
    if state
        ...
        .is_err()
    {
        warn!("No receivers for monitor change event (deleted: {name})");
    }
